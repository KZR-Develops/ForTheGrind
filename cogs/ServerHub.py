...
class Setup(commands.Cog):
    ...
    async def setupHub(self, ctx):
        ...
        startEmbed.add_field(
            name="<:website:1160096124527452250> Quick Links",
            value="<:Empty:1134737303324065873><:SBB:1134737393921036348> [Facebook Page](https://www.facebook.com/FTGEsportsGG)\n<:Empty:1134737303324065873><:SBB:1134737393921036348> [Discord Server](https://discord.gg/GyNf93SAVf)",
            inline=True,
        )
        startEmbed.add_field(
            name="<:redbook:1160100642891759686> Quick Information",
            value="<:Empty:1134737303324065873><:SBB:1134737393921036348> Co-Owners: <@713953519597518939> & <@239004733027778561>\n<:Empty:1134737303324065873><:SBB:1134737393921036348> Created at: July 28, 2023 @ 10:46 AM",
            inline=True,
        )
...
class startHub(discord.ui.View):
    ...
    @discord.ui.button(
        ...
        custom_id="sH:start:gray",
        emoji="<:redbook:1160100642891759686>",
    )
    async def serverRules(
        ...
        if interaction.user.get_role(1145298592173662269):
            message1 = await interaction.response.send_message(
                embed=rulesP1, ephemeral=True
            )
...
class rulesPg2(discord.ui.View):
    ...
    @discord.ui.button(
        label="Next Page",
        style=discord.ButtonStyle.gray,
        custom_id="sh:nextPage:gray",
        emoji="<:B6:1134737298030874634>",
    )
    async def nextPage(self, interaction: discord.Interaction, button: discord.Button):
        ...
        await interaction.response.send_message(
            embed=rulesP2, view=rulesP3(), ephemeral=True, delete_after=240
        )
...
class rulesP3(discord.ui.View):
    ...
    async def nextPage(self, interaction: discord.Interaction, button: discord.Button):
        ...
        await interaction.response.send_message(
            embed=rulesP3, view=rulesP4(), ephemeral=True, delete_after=240
        )
...
class rulesP4(discord.ui.View):
    ...
    async def nextPage(self, interaction: discord.Interaction, button: discord.Button):
        ...
        if interaction.user.get_role(1145298592173662269):
            await interaction.response.send_message(
                embed=rulesP4, ephemeral=True, delete_after=240
            )
        else:
            await interaction.response.send_message(
                embed=rulesP4, view=Verification(), ephemeral=True, delete_after=240
            )
...
class Verification(discord.ui.View):
    ...
    async def nextPage(self, interaction: discord.Interaction, button: discord.Button):
        ...
        await interaction.response.send_message(
            embed=embedVerification, ephemeral=True, view=Verify(), delete_after=240
        )
...
class Verify(discord.ui.View):
    ...
    @discord.ui.button(
        label="Verify", style=discord.ButtonStyle.danger, custom_id="verify:danger"
    )
    async def verify(self, interaction: discord.Interaction, button: discord.Button):
        ...
        embedVerified = discord.Embed(
            description="Great! You have successfully completed the verification process.  Feel free to start conversing and connecting with fellow members.\n\nHappy navigating!",
            color=0x00FF00,
        )
